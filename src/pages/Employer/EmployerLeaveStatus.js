                    ...
                    <div className="status-left-div">
                        ...
                        <div className="status-left-div-container">
                            <article class="Status-left-div-white" id="Status-left-div-white-1">
                                <h2 class="Status-left-div-mini-text">Start Date: 22 Oct 2020 <br></br>End Date: 23 Oct 2020 <br></br>Leave Type: Annual <br></br>Manager: Peter <br></br>Status: Pending <br></br></h2>
                                <Popconfirm
                            ...
                            <article class="Status-left-div-white" id="Status-left-div-white-2">
                                <h2 class="Status-left-div-mini-text">Start Date: 19 Oct 2020 <br></br>End Date: 20 Oct 2020 <br></br>Leave Type: Medical<br></br>Reason: Fever<br></br> Manager: Peter <br></br>Status: Approved <br></br></h2>
                                <Popconfirm
                                    title="Are you sure you want cancel this leave?"
                                    okText="Yes"
                                    cancelText="No"
                            ...
                            <article class="Status-left-div-white" id="Status-left-div-white-3">
                                <h2 class="Status-left-div-mini-text">Start Date: 10 Oct 2020 <br></br>End Date: 11 Oct 2020 <br></br>Leave Type: Unpaid <br></br>Manager: Peter <br></br>Status: Approved <br></br></h2>
                                <Popconfirm
                                    title="Are you sure you want cancel this leave?"
                                    okText="Yes"
                                    cancelText="No"
...
export default EmployerLeaveStatus;