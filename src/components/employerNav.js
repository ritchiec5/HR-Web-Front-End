...
function EmployerNav () { 
    ...
    <>
            <ul>
                ...
                >
                    <a id='home_name' href="/Employer">HR Application</a>
                </Button>

                <div className='middle_employer'>
                    <li className='dropdown'>
                        <button className='dropbtn'>
                            Leave
                        </button>
                            <div className='drop-content'>
                                <a href="/Employer/Leave/Status">Status</a>
                                <a href="/Employer/Leave/Apply">Apply</a>
                            </div>
                    </li>
                    ...
                    <li className='dropdown'>
                        ...
                        <div className='drop-content'>
                            <a href="/Employer/Claim/Status">Status</a>
                            <a href="/Employer/Claim/Apply">Apply</a>
                        </div>
                    </li>

                    <li><a href="/Employer/Payslip">Payslip</a></li>
                    ...
                    <li className='dropdown'>
                        ...
                        <div className='drop-content'>
                            <a href="/Employer/Approval/Leave">Leave</a>
                            <a href="/Employer/Approval/Claim">Claim</a>
                        </div>
                    </li>
                </div>
